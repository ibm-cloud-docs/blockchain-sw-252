...
<a href="/docs/blockchain-sw-251?topic=blockchain-sw-251-upgrade-k8">2.5.1</a>, 2.5.2
</p>
...
```
kubectl set image deploy/ibp-operator -n <NAMESPACE> ibp-operator="cp.icr.io/cp/ibp-operator:2.5.2-20211116-amd64"
```
{: codeblock}
