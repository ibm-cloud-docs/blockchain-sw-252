...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
        - name: ibp-operator
          image: cp.icr.io/cp/ibp-operator:2.5.2-20220308-amd64
          command:
            - ibp-operator
          imagePullPolicy: Always
          securityContext:
