...
```
kubectl set image deploy/ibp-webhook -n ibpinfra ibp-webhook="cp.icr.io/cp/ibp-crdwebhook:2.5.2-20211214-amd64"
```
{: codeblock}
...
```
kubectl set image deploy/ibp-operator -n <PROJECT_NAME> ibp-operator="cp.icr.io/cp/ibp-operator:2.5.2-20211214-amd64"
```
{: codeblock}
...
```yaml
cp.icr.io/cp/ibp-operator:2.5.2-20211214-amd64
```
{: codeblock}
...
```
<LOCAL_REGISTRY>/ibp-operator:2.5.2-20211214-amd64
```
{: codeblock}
