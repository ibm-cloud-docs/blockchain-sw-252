...
<a href="/docs/blockchain-sw-251?topic=blockchain-sw-251-upgrade-ocp">2.5.1</a>, 2.5.2
</p>
...
```
kubectl set image deploy/ibp-webhook -n ibpinfra ibp-webhook="cp.icr.io/cp/ibp-crdwebhook:2.5.2-20211116-amd64"
```
{: codeblock}
...
```
kubectl set image deploy/ibp-operator -n <PROJECT_NAME> ibp-operator="cp.icr.io/cp/ibp-operator:2.5.2-20211116-amd64"
```
{: codeblock}
...
```yaml
cp.icr.io/cp/ibp-operator:2.5.2-20211116-amd64
```
{: codeblock}
...
```
<LOCAL_REGISTRY>/ibp-operator:2.5.2-20211116-amd64
```
{: codeblock}
