...
- **Up-to-date Fabric key features**. Choose which version of Hyperledger Fabric you want to use when deploying peers or ordering nodes. Leverage the latest features of Hyperledger Fabric v1.4.10 and v2.2.2:
...
- **Run Anywhere**. Thanks to the **unified codebase** of the {{site.data.keyword.blockchainfull_notm}} Platform console, it is possible to run your components on any Kubernetes v1.17 - v1.19 container platform on x86_64 or s390x.
...
- The console creates nodes based on the Hyperledger Fabric v1.4.10 and v2.2.2 node images.
