...
<a href="/docs/blockchain-sw-251?topic=blockchain-sw-251-console-ocp-about">2.5.1</a>, 2.5.2
</p>
...
- The console creates nodes based on the Hyperledger Fabric v1.4.12 and v2.2.4 node images.
