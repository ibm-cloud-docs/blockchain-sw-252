...
Documentation for this on-prem product has been moved from IBM Cloud to IBM Documentation at [https://www.ibm.com/docs/en/SSVKZ7_2.5.2/vscode-extension.html](https://www.ibm.com/docs/en/SSVKZ7_2.5.2/vscode-extension.html){: external}. Update your bookmarks.
{: important}
...
To deploy a smart contract to a preconfigured network, you can use an existing {{site.data.keyword.blockchainfull_notm}} Platform network. See the instructions in [Step six](#develop-vscode-connecting-ibp) to connect to that network.
