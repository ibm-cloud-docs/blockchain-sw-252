...
Documentation for this on-prem product has been moved from IBM Cloud to IBM Documentation at [https://www.ibm.com/docs/en/SSVKZ7_2.5.2/howto-install-k8s.html](https://www.ibm.com/docs/en/SSVKZ7_2.5.2/howto-install-k8s.html){: external}. Update your bookmarks.
{: important}
